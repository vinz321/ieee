...
IL_0031:
	{
		...
		int64_t L_15 = __this->___m_NextId_5;
		V_4 = L_15;
		int64_t L_16 = V_4;
		__this->___m_NextId_5 = ((int64_t)il2cpp_codegen_add(L_16, ((int64_t)1)));
		int64_t L_17 = V_4;
		NullCheck(L_14);
		L_14->___ActionId_2 = L_17;
		V_0 = L_14;
		// if (m_NextId < k_MinimumIdValue)
		int64_t L_18 = __this->___m_NextId_5;
...
IL_008d:
	{
		// lock (m_Lock)
		RuntimeObject* L_20 = __this->___m_Lock_1;
		V_6 = L_20;
		V_7 = (bool)0;
	}
	{
...
IL_00d2:
		...
		{// begin try (depth: 1)
			...
			ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_29 = V_0;
			NullCheck(L_26);
...
IL_00d3:
	{
		...
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_30 = V_0;
		NullCheck(L_30);
...
IL_002a_1:
			{
				...
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_8 = __this->___m_IdScheduledInvocationMap_3;
				int64_t L_9 = ___actionId0;
				NullCheck(L_8);
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_10;
				L_10 = Dictionary_2_get_Item_mFF139C50AEE548A51800EB755A2409B5AF324B30(L_8, L_9, Dictionary_2_get_Item_mFF139C50AEE548A51800EB755A2409B5AF324B30_RuntimeMethod_var);
				V_2 = L_10;
				// m_ScheduledActions.Remove(scheduledInvocation);
				MinimumBinaryHeap_1_tB7A85B4D870F0107AF6031545D6054927A1CB7AD* L_11 = __this->___m_ScheduledActions_2;
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_12 = V_2;
				NullCheck(L_11);
				MinimumBinaryHeap_1_Remove_mB0E42318CD574177F32E7FECD9CE8C3B6F1DB464(L_11, L_12, MinimumBinaryHeap_1_Remove_mB0E42318CD574177F32E7FECD9CE8C3B6F1DB464_RuntimeMethod_var);
				// m_IdScheduledInvocationMap.Remove(scheduledInvocation.ActionId);
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_13 = __this->___m_IdScheduledInvocationMap_3;
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_14 = V_2;
				NullCheck(L_14);
				int64_t L_15 = L_14->___ActionId_2;
				NullCheck(L_13);
				bool L_16;
				L_16 = Dictionary_2_Remove_m4EEA35DDD180B435CA4CCB7714A4FF4844ADFE34(L_13, L_15, Dictionary_2_Remove_m4EEA35DDD180B435CA4CCB7714A4FF4844ADFE34_RuntimeMethod_var);
				goto IL_0064;
			}
		}// end try (depth: 1)
		catch(Il2CppExceptionWrapper& e)
